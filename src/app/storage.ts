...
export async function checkStorage(database: SqlQueryable): Promise<void> {
  ...
  const probes = {
    ...
    agent_model_budget_calls: 'root_work_id,call_id,input_tokens,output_tokens,cost_micros',
    ...
    agent_claim_requests: 'request_id,worker_id,completed,response,created_at',
