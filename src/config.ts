...
export function loadModelBudget(env: NodeJS.ProcessEnv = process.env): RootModelBudgetOptions {
  return {
    maxModelCalls: intEnv('AGENT_OS_MAX_MODEL_CALLS', 128, { min: 1 }, env),
    maxTokens: intEnv('AGENT_OS_MAX_MODEL_TOKENS', 1_000_000, { min: 1 }, env),
    maxCostMicros: intEnv('AGENT_OS_MAX_COST_MICROS', 10_000_000, { min: 1 }, env),
    wallClockMs: intEnv('AGENT_OS_MODEL_DEADLINE_MS', 1_800_000, { min: 1000 }, env),
