...
const signalIndex: Record<keyof HostPort, number> = { claimWork: 0, waitForWork: 2, streamPreview: 2, heartbeat: 1, loadContext: 1, loadInitialContext: 1, reserveModelCall: 3,
