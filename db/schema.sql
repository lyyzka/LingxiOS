-- LingxiOS Agent OS — control-plane schema (protocol v8)
--
...
-- Advisory, transaction-committed wakeups; durable rows remain the source of truth.
CREATE FUNCTION lingxios.notify_runtime() RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
...
CREATE TRIGGER agent_delivery_wakeup AFTER INSERT
